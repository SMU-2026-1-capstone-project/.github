...
| 레포 | 내용 |
| :--- | :--- |
| [Shadowfit/init](https://github.com/Shadowfit/init) | 통합 모노레포 — 프론트엔드·백엔드·AI 서버를 한 곳에서 개발 |
| [Shadowfit/backend](https://github.com/Shadowfit/backend) | Spring Boot 백엔드 (모노레포에서 자동 미러링) |
| [Shadowfit/frontend](https://github.com/Shadowfit/frontend) | React Native(Expo) 프론트엔드 (모노레포에서 자동 미러링) |
| [Shadowfit/ai-server](https://github.com/Shadowfit/ai-server) | FastAPI AI 서버 (모노레포에서 자동 미러링) |

모듈별 레포는 `Shadowfit/init`의 각 폴더가 push마다 GitHub Actions로 자동 동기화된 읽기 전용 미러입니다. 실제 개발과 이슈·PR은 모노레포에서 이뤄집니다.
